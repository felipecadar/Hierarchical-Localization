...
OUTPUT=$SCRATCH/Datasets/hloc/outputs/alike_netvlad/cmu_extended

EXTRACTOR=alike
MATCHER=NN-mutual
GLOBAL_EXTRACTOR=netvlad

python -m hloc.pipelines.CMU.pipeline --dataset $DATASET --outputs $OUTPUT --extractor $EXTRACTOR --matcher $MATCHER --global_extractor $GLOBAL_EXTRACTOR